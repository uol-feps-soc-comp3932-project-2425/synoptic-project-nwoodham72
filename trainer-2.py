...
from transformers import AutoTokenizer, DistilBertForSeq2SeqLM, Trainer, TrainingArguments
...
# Validation set
validation_articles = dataset["validation"]["article"][:100]  # Validate on first 100 articles
validation_summaries = dataset["validation"]["highlights"][:100]  # Validate on first 100 summaries
...
model = DistilBertForSeq2SeqLM.from_pretrained(model_name)
