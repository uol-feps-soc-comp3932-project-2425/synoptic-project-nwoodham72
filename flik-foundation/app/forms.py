...
class RaiseBugForm(FlaskForm):
    ...
    role = SelectField("Application Role", choices=[], validators=[DataRequired()], render_kw={"id": "role"})
    page = SelectField("Application Page", choices=[], validators=[DataRequired()], render_kw={"id": "page"})
