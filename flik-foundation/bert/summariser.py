...
""" summariser.py: Handles bug ticket summarisation using the Hugging Face DistilBERT model. """
...
):  # :param text: The full bug description. :param ratio: Fraction of sentences to retain.
