...
# Step 1: Load DistilBERT-based Summarizer
distilbert_summarizer = Summarizer(model="distilbert-base-uncased")

def extractive_summary(text, ratio=0.3):
    """
    Generates an extractive summary by selecting the most relevant sentences.

    :param text: The full bug description.
    :param ratio: Fraction of sentences to keep (default: 30%).
    :return: Extracted summary.
    """
    summary = distilbert_summarizer(text, ratio=ratio)
    return summary
